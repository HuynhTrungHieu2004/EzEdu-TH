                ...
                <tbody>
                  {items.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td><button type="button" className="btn-secondary" disabled={!item.question_set_id} onClick={() => item.question_set_id && navigate(`/question-sets/${item.question_set_id}`)}>Xem lại / Làm lại</button></td>
                    </tr>
                  ))}
                </tbody>
              </table>
