 ...
 * mất khoảng 105 giây (đo ngày 16/08/2026). Không có thông báo này thì lần đầu
 * vào buổi sáng ứng
...
export default function ServerWakingNotice() {
  ...
  return (
    <div className="ez-waking" role="status" aria-live="polite">
      ...
      <span>Máy chủ đang khởi động lại, thường mất một đến hai phút. Bạn không cần tải lại trang.</span>
    </div>
  );
}
