...
const styles = {
  ...
  icon: {
    ...
    borderRadius: '10px', color: 'var(--ez-primary)', background: 'var(--ez-surface)',
  },
  subtle: { marginTop: '3px', fontSize: '12px', color: 'var(--ez-text-muted)', lineHeight: 1.45 },
  suggestion: {
    marginBottom: '14px', padding: '9px 11px', borderRadius: '8px', fontSize: '12px',
    color: 'var(--ez-text-secondary)', background: 'var(--ez-surface)', border: '1px solid var(--ez-border)',
  },
  grid: {
  ...
  label: { fontSize: '12px', fontWeight: '700', color: 'var(--ez-text-secondary)' },
  processing: {
    display: 'flex', alignItems: 'center', gap: '12px', padding: '12px',
    borderRadius: '9px', background: 'var(--ez-surface)', border: '1px solid var(--ez-border)',
  },
  spinner: {
    width: '18px', height: '18px', flex: '0 0 18px', border: '2px solid var(--ez-border)',
    borderTop: '2px solid var(--ez-primary)', borderRadius: '50%', animation: 'spin 0.8s linear infinite',
  },
  notice: {
    marginBottom: '12px', padding: '10px 12px', borderRadius: '8px', fontSize: '12px',
    color: 'var(--warning-text)', background: 'var(--ez-warning-subtle)', border: '1px solid var(--ez-border-strong)',
  },
  error: {
    display: 'flex', gap: '7px', alignItems: 'center', marginTop: '10px', fontSize: '12px', color: 'var(--ez-error)',
  },
};
